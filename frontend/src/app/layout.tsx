  ...
  return (
    <html lang="en">
      ...
      >
        ...
        {/*
          ErrorBoundary catches any unhandled client exception — including
          WalletConnect "Origin not found on Allowlist" crashes — and shows
          a helpful message instead of a blank white screen.
        */}
        <ErrorBoundary>
          <Providers>
            <NavBar />
